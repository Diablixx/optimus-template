...
export const metadata = {
  title: 'Connexion | Optimus',
  description: 'Connectez-vous à votre espace client Optimus pour accéder à vos formations et ressources.',
};
        ...
        <div className="max-w-md w-full space-y-8">
          <div>
            ...
            <p className="mt-2 text-center text-sm text-gray-600">
              Accédez à vos formations et ressources premium
            </p>
          </div>
